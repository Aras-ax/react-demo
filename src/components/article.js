...
class Article extends React.Component {
  ...
  render() {
    let likeText = `赞同 ${formatNum(this.props.like)}`;
    return (
      <div className="contentItem">
        <h2 className="contentItem-title">{this.props.title}</h2>
        <div className="richcontent">
          <div className="richcontent-inner">{this.props.content}</div>
          <div className="contentItem-actions">
            <button
              type="button"
              onClick={e => {
                this.props.onLike(1, e);
              }}
    ...
    return (
      <div className="article">
        <Article
          ...
          thank={this.props.thank}
          collection={this.collection}
          onLike={type => {
            this.props.onLike(type, this.props.ID);
          }}
        />
